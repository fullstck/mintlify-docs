...
<ParamField query="advertPriceMin" type="number">
  Minimum price of advert. Filters on advert price, not on property price. Only non-expired adverts are considered.
</ParamField>

<ParamField query="advertPriceMax" type="number">
  Maximum price of advert. Filters on advert price, not on property price. Only non-expired adverts are considered.
</ParamField>
