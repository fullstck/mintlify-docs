...
| `withCoherentPrice` | `true` | `true` keeps coherent prices, `false` keeps incoherent ones (both also include unassessed listings) — `null`/empty disables the filter, omitted defaults to `true` |
